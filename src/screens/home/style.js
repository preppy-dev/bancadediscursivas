...
.landing-page {
  ...
  .btn-outline-semi-light {
    ...
    &:hover,
    &:active {
      border: 1px solid darken(#236591, 10%);
      background: darken(#236591, 10%);
    }
  }
  ...
  .landing-page-nav .headroom--pinned {
    ...
    .navbar-nav {
      ...
      .btn-outline-semi-light {
        border: 1px solid rgba(#236591, 0.3);
        color: #236591;
  ...
  form.dark-background {
    ...
    .has-top-label > span,
    .has-top-label label {
      color: rgba(#d0d0d0, 0.6);
    }

    .bootstrap-tagsinput,
    .form-control {
      background: transparent;
      border-color: rgba(#d0d0d0, 0.3);
      color: #d0d0d0;

      &:focus,
      &:active {
        border-color: rgba(#d0d0d0, 0.6);
      }
    }
  }
